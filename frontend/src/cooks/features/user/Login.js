                            ...
                            <div className="hero min-h-full rounded-l-xl bg-base-200">
                                <div className="hero-content p-2">
                                    <div className="w-50 px-6 py-4">
                                        ...
                                        <div className="my-auto"><img width={500} height={400} src="https://irancuisinetours.com/wp-content/uploads/2016/06/cholo-soltani-870x480.jpg" style={{ borderRadius: '12px' }} alt="اقامتگاه" className="inline-block"></img></div>
                                    </div>
                                </div>
                            </div>
                        </div>
