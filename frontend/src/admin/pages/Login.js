                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 bg-base-100 rounded-xl">
                            ...
                            <div className="hero min-h-full rounded-l-xl bg-base-200">
                                <div className="hero-content p-2">
                                    <div className="w-50 px-6 py-4">
                                        <h1 className="mb-4 text-center font-bold text-lg"> ورود به پنل ادمین</h1>
                                        <div className="my-auto"><img width={500} height={400} src="https://img.freepik.com/premium-photo/log-cabin-mountains-with-sunset-background_865967-19459.jpg?ga=GA1.1.183878651.1734187720&semt=ais_hybrid" style={{ borderRadius: '12px' }} alt="اقامتگاه" className="inline-block"></img></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {isLogin ? (
                            ...
                            <div className="flex flex-col bg-white px-2 sm:px-2 md:px-2 lg:px-2 py-2 w-full max-w-md m-auto">
                                ...
                                <div className="relative mt-4 h-px bg-gray-300">
                                    <div className="absolute left-0 top-0 flex justify-center w-full -mt-2">
                                        <span className="bg-white px-4 text-xs text-gray-500 uppercase">ورود به پنل ادمین </span>
                                    </div>
                                </div>
                                            ...
                                            <div className="relative mb-4">
                                                ...
                                                <div className="flex items-center mb-6">
                                                    <div className="flex ml-auto">
                                                        <Link to="/admins/forgot-password" className="inline-flex text-xs font-bold sm:text-sm text-blue-800 hover:text-blue-900">گذرواژه خود را فراموش کردید؟</Link>
                                                    </div>
                                                </div>
                                            </div>
