...
function Login() {
    ...
    const login = (e) => {
        ...
        if (phone && password) {
            ...
            axios.post('/api/owners/auth/login', { phone, password }, config).then((data) => {

                localStorage.setItem("userId", data.data._id)

                if (data) {
                    axios.post('/api/owners/auth/send-otp', { phone }, config).then((otpData) => {
    ...
    const verify = (e) => {
        ...
        if (code) {
            ...
            axios.post('/api/owners/auth/verify-otp', { phone, code }, config).then((data) => {
                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 bg-base-100 rounded-xl">
                            ...
                            <div className="hero min-h-full rounded-l-xl bg-base-200">
                                <div className="hero-content p-2">
                                    <div className="w-50 px-6 py-4">
                                        <h1 className="mb-4 text-center font-bold text-lg"> ورود به پنل ملک دارها</h1>
                                        <div className="my-auto w-50 h-50"><img width={550} height={250} src="https://img.freepik.com/free-photo/flat-lay-real-estate-concept_53876-14502.jpg?ga=GA1.1.1404144783.1745138448&semt=ais_hybrid&w=740" style={{ borderRadius: '12px' }} alt="اقامتگاه" className="inline-block"></img></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {isLogin ? (
                            ...
                            <div className="flex flex-col bg-white px-2 sm:px-2 md:px-2 lg:px-2 py-2 w-full max-w-md m-auto">
                                ...
                                <div className="relative mt-4 h-px bg-gray-300">
                                    <div className="absolute left-0 top-0 flex justify-center w-full -mt-2">
                                        <span className="bg-white px-4 text-xs text-gray-500 uppercase">ورود به پنل ملک دارها </span>
                                    </div>
                                </div>
