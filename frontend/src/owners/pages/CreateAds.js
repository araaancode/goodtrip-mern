...
// Icons (keeping your existing icons and adding some for consistency)
...
import { FiInfo, FiUpload, FiX, FiFile, FiCheckCircle, FiImage } from "react-icons/fi";
...
function CreateAds() {
  ...
  const handleFileDelete = (index, files, setFiles, field) => {
  ...
  const validateForm = () => {
    ...
    if (selectedFiles2.length === 0) newErrors.photos = "* تصاویر آگهی الزامی است";
          ...
          <div className="p-6 md:p-8">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                >
                  ...
                  <input
                    ...
                    className="hidden"
                    onChange={(e) =>
                      handleFileChange(e, setSelectedFiles, "photo")
                    }
                      ...
                      {selectedFiles.map((file, index) => (
                        ...
                        >
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              handleFileDelete(index, selectedFiles, setSelectedFiles, "photo")
                            }
                ...
                <div
                  ...
                  onDrop={(e) =>
                    handleDrop(e, setIsDragOver2, (files) =>
                      processFiles(files, setSelectedFiles2, "photos")
                    )
                  }
                >
                  <div
                  ...
                  <input
                    ...
                    className="hidden"
                    onChange={(e) =>
                      handleFileChange(e, setSelectedFiles2, "photos")
                    }
                    onClick={(e) => (e.target.value = null)}
                  />
                </div>
                      ...
                      {selectedFiles2.map((file, index) => (
                        ...
                        >
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              handleFileDelete(index, selectedFiles2, setSelectedFiles2, "photos")
                            }
                            className="text-red-500 hover:text-red-700 p-2 rounded-xl hover:bg-red-50 transition-all duration-200 flex-shrink-0"
                            aria-label="حذف فایل"
                          >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                ...
                <div className="flex flex-col">
                  <label className="mb-3 text-base font-semibold text-gray-800 flex items-center">
                    <IoIosInformationCircleOutline className="ml-2 text-blue-500" />
                    توضیحات آگهی
                    <span className="text-red-500 mr-1">*</span>
                  </label>
                  <div className="relative group">
