...
function ForgotPassword() {
  const { forgotPassword, isLoading } = useOwnerAuthStore();
                  ...
                  <div className="w-50 px-6 py-4">
                    ...
                    <div className="my-auto">
                      <img 
                        width={500} 
                        height={400} 
                        src="https://img.freepik.com/free-photo/3d-illustration-wrong-password-screen-red-lock_107791-16604.jpg" 
            ...
            <div className='flex flex-col bg-white px-2 sm:px-2 md:px-2 lg:px-2 py-2 w-full max-w-md mx-auto my-2'>
              ...
              {linkSent ? (
                <div className="text-center my-8">
                  <p className="text-green-600 mb-4">لینک بازنشانی گذرواژه به ایمیل شما ارسال شد.</p>
                  <p className="text-gray-600">لطفا ایمیل خود را بررسی کنید.</p>
                </div>
              ) : (
                <>
                  <p className='mb-6 mt-4 text-right text-gray-500'>برای تغییر گذرواژه ایمیل خود را در زیر وارد کنید</p>
                  <form onSubmit={handleSubmit}>
                    <div className="flex flex-col mb-2 sm:px-2">
                      ...
                      <span className='text-red-500 relative text-sm'>{emailError}</span>
                    </div>
              ...
              <p className='text-sm text-gray-800 mt-2 px-2'>حساب ندارید؟ <Link to='/owners/register' className='hover:text-blue-900 hover:cursor-pointer'>ثبت نام </Link></p>
            </div>
          </div>
        </div>
      </div>
