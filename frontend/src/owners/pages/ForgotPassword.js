...
function ForgotPassword() {
  ...
  const sendEmail = async (e) => {
    ...
    if (!email || email === "" || email === undefined || email === null) {
      ...
      await axios
        .post("/api/owners/auth/forgot-password", { email }, config)
        .then((data) => {
          if (data) {
            console.log(data);

            toast.info(
              "ایمیل بازنشانی فرستاده شد. لطفا ایمیل خود را بررسی کنید.",
              {
                position: "top-right",
                autoClose: 5000,
        ...
        <div className="card mx-auto w-full max-w-5xl shadow-xl">
          <div className="grid md:grid-cols-2 grid-cols-1  bg-base-100 rounded-xl">
                  ...
                  <div className="w-50 px-6 py-4">
                    ...
                    <div className="my-auto">
                      <img
                        width={500}
                        height={400}
                        src="https://img.freepik.com/free-photo/3d-illustration-wrong-password-screen-red-lock_107791-16604.jpg?ga=GA1.1.1404144783.1745138448&semt=ais_hybrid&w=740"
            ...
            <div className="flex flex-col bg-white px-2 sm:px-2 md:px-2 lg:px-2 py-2 w-full max-w-md mx-auto my-2">
              ...
              <p className="mb-6 mt-4 text-right text-gray-500">
                برای تغییر گذرواژه ایمیل خود را در زیر وارد کنید
              </p>
