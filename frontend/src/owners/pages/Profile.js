  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        // setProvinces(res.data.owner.province);
        // setCities(res.data.owner.city);
        ...
        <form onSubmit={updateProfile}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <div className="flex flex-col my-4">
              ...
              {owner.province ? (
                <small className="mt-2 font-sm text-gray-500">
                  استان انتخاب شده: * {owner.province}
                </small>
              ) : (
                <span></span>
              )}
            ...
            {/* city */}
            <div className="flex flex-col my-4">
              <label className="text-xs sm:text-sm tracking-wide text-gray-600 block mb-1">
                شهرستان
              </label>
              {owner.city ? (
                <small className="mt-2 font-sm text-gray-500">
                  شهرستان انتخاب شده: * {owner.city}
                </small>
              ) : (
                <span></span>
              )}
          ...
          <button className="app-btn-blue mt-4">
            {btnSpinner ? (
