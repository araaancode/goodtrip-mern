...
function Register() {
    ...
    const register = (e) => {
        ...
        if (!password || password === "" || password === undefined || password === null) {
            ...
            setPasswordErrorMsg("* گذرواژه باید وارد شود")
        }
            ...
            try {
                axios.post(`/api/owners/auth/register`, { name, username, email, phone, password }, {
                    headers: {
                            ...
                            <div className="hero min-h-full rounded-l-xl bg-base-200">
                                <div className="hero-content p-2">
                                    <div className="w-50 px-6 py-4">
                                        <h1 className="mb-4 text-center font-bold text-lg"> ثبت نام در پنل ملک دارها</h1>
                                        <div className="my-auto"><img width={500} height={400} src="https://www.cjhole.co.uk/wp-content/uploads/2024/04/shutterstock_2195995789.jpg" style={{ borderRadius: '12px' }} alt="اقامتگاه" className="inline-block"></img></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col bg-white px-2 sm:px-2 md:px-2 lg:px-2 py-2 w-full max-w-md m-auto">
                            ...
                            <div className="relative mt-4 h-px bg-gray-300">
                                <div className="absolute left-0 top-0 flex justify-center w-full -mt-2">
                                    <span className="bg-white px-4 text-xs text-gray-500 uppercase"> ثبت نام در  پنل ملک دارها </span>
                                </div>
                            </div>
                            <div className="mt-2 rounded-sm">
                                <form className="space-y-2 mt-2">
                                    <div className="container mx-auto p-4">
                                        ...
                                        <p className='text-sm text-gray-800'>حساب دارید؟ <Link to='/owners/login' className='hover:text-blue-900 hover:cursor-pointer'>ورود </Link></p>
                                    </div>
