...
function AddNewAdmin({closeModal}){
    ...
    const saveNewLead = () => {
        ...
        else if(leadObj.password.trim() === "")return setErrorMessage("گذرواژه باید وارد شود!")
        else if(leadObj.confirmPassword.trim() === "")return setErrorMessage("تایید گذرواژه باید وارد شود!")
        else{
            let newLeadObj = {
                "id": 7,
                "email": leadObj.email,
    ...
    return(
        <>
            ...
            <InputText type="password" defaultValue={leadObj.password} updateType="password" containerStyle="mt-4" labelTitle="گذرواژه" updateFormValue={updateFormValue}/>
            <InputText type="password" defaultValue={leadObj.confirmPassword} updateType="password" containerStyle="mt-4" labelTitle="تایید گذرواژه" updateFormValue={updateFormValue}/>
